    ...
    <v-row justify="center">
        ...
        >
            <v-card color="tertiary-light">
                <v-card-title>
                    <span class="text-h5">Pay Bid</span>
                </v-card-title>
                <v-card-text>
                        ...
                        <v-row>
                            <v-col cols="12" md="6">
                                <v-text-field
                                    ...
                                    type="number"
                                    persistent-hint
                                    :hint="`Price per unit: N${bid.unit_price}`"
                            ...
                            <v-col cols="12" md="6">
                                <v-text-field
                                    shaped
                                    filled
                                    :value="bid.unit_price * bid.units"
                                    type="number"
                                    readonly
                                    label="Total Amount*"
                                    required
    ...
    methods: {
        async pay() {
            try {
                ...
                const res = await this.$store.dispatch("projects/payBid", {
                    bidId: this.bid.id,
                    ...this.form,
                });
